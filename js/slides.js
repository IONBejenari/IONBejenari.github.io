...
(function($) {
  $.widget("js.slides", {
		options: {
			width: 790, // [Number] Define the slide width
			responsive: false, // [Boolean] slideshow will scale to its container
			height: 460, // [Number] Define the slide height
			...
			playInterval: 3200, // [Number] Time spent on each slide in milliseconds
			pauseInterval: 4000, // [Number] Time spent on pause, triggered on any navigation or pagination click
